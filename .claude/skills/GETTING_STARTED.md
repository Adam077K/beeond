...
Don't panic about the 426+ skills. You don't need them all at once.
...
| **Antigravity** | ✅ Native       | Global: `~/.gemini/antigravity/skills/` · Workspace: `.claude/skills/` |
...
**Q: Do I need to install all 426+ skills?**
