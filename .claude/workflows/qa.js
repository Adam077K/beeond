...
const DIMENSIONS = [
  ...
  { key: 'patterns', critical: false, lens: 'Beeond conventions (repo conventions, Zod on inputs, TS strict, error handling, no placeholder UI), naming, dead code, duplication' },
...
function verifyPrompt(f, lensIndex) {
  ...
  return `Adversarially verify ONE claimed QA finding against the real Beeond diff (\`git diff ${REF}\`).
