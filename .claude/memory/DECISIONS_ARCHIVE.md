# Decision Archive — pre-2026-08-08

**Frozen. Historical record only. Never current instruction.**

These 24 entries were the active decision log until the 2026-08-08 clean-start reset.
They are archived rather than deleted because the *reasoning* is often still instructive
and because handoff file 05 credits this log as the reason the project's history is
reconstructable at all.

**What they wrongly describe as live:** seven marketing-site directions (v3–v7, all
retired 2026-08-26), the v7 Blueprint SPEC (deleted), the Footprint-Audit wizard (never
built), every brand system and palette lock, and a settled ICP / pricing tiers / service
catalog — all reopened by the 2026-08-08 reset.

Source of truth: `HANDOFF-CLEAN-START/`. Current decisions: `DECISIONS.md`.
Recovery anchor for the 2026-08-26 cleanup: git tag `pre-clean-start-2026-08-26`.
