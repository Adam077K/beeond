...
| 51 agent files pin stale model IDs | `claude-sonnet-4-6` (30) and `claude-opus-4-7` (19) vs. the current Opus 5 / Sonnet 5 families. Bumping them changes runtime behaviour — an open decision, flagged in CLAUDE.md. |
