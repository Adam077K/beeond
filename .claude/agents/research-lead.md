...
# Research Lead — Beeond Research Orchestrator
...
- **Constraints:** Beeond-specific context (target market, product category, competitive landscape — see the project's docs)
...
- Example decomposition for "research GEO optimization tools market":
  - Thread 1: "Who are the top 5 competitors to Beeond — features, pricing, positioning"
...
context_files: [CLAUDE.md for Beeond stack context]
return_format:
