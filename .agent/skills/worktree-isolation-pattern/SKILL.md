...
description: "The exact git worktree create, detect, and clean pattern for Beeond workers: detect-or-create from main-repo-root, child worktree commands, branch naming conventions (feat/fix/chore), atomic commits, and .worktrees/ gitignore enforcement."
tags: [git, beeond-specific, workflow, workers]
source: beeond-authored 2026-05-16
risk: low
---
...
# /Users/adamks/VibeCoding/Beeond                      abc1234 [main]
# /Users/adamks/VibeCoding/Beeond/.worktrees/ceo-1-xxx  def5678 [ceo-1-xxx]
...
pnpm -F @beeond/web exec tsc --noEmit apps/web/src/app/api/scan/route.ts

# Lint
pnpm -F @beeond/web lint --max-warnings 0
```
...
# Run relevant tests
pnpm -F @beeond/web test -- --testPathPattern="scan"
...
```json
{
  ...
  "worktree": "/Users/adamks/VibeCoding/Beeond/.worktrees/scan-rate-limit",
  "files_changed": [
